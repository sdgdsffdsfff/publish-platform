...
<div class="content_box clearfix">
    ...
    <div class="content fr" id="scroll">
        <div class="m20">
            <div class="nav">
                <a href="/filetype/list?tid=${tid}&fid=1" <c:if test="${fid==1}"> class="on" </c:if>>应用软件更新包管理</a>
                <a href="/filetype/list?tid=${tid}&fid=2" <c:if test="${fid==2}"> class="on" </c:if>>应用软件资源包管理</a>
                <a href="/pub/list?tid=${tid}&fid=1" >应用软件更新发布管理</a>
                <a href="/pub/list?tid=${tid}&fid=2">应用软件资源发布管理</a>
            </div>
            <div class="con_box">
                <div class="p10">
